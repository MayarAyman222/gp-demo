...
const Landing = () => {
  ...
  const texts = {
    en: {
      ...
      feature1: { title: "Easy Communication", desc: "Express needs and feelings through intuitive visual icons." },
      feature2: { title: "Large Icon Library", desc: "Hundreds of categorized icons for daily life communication." },
      feature3: { title: "Fast & Simple", desc: "Clean interface designed for seniors and kids." },
      usersTitle: "Who Can Use Voxi?",
      user1: "Autism",
      user2: "Stroke Survivors",
      user3: "Alzheimer’s",
      user4: "Speech Difficulty",
    ...
    ar: {
      ...
      feature1: { title: "تواصل سهل", desc: "عبّر عن احتياجاتك ومشاعرك باستخدام رموز بصرية بديهية." },
      feature2: { title: "مكتبة أيقونات كبيرة", desc: "مئات الأيقونات المصنفة للتواصل اليومي." },
      feature3: { title: "سريع وبسيط", desc: "واجهة نظيفة مصممة لكبار السن والأطفال." },
      usersTitle: "من يمكنه استخدام فوكسى؟",
      user1: "التوحد",
      user2: "ناجون من السكتة الدماغية",
      user3: "الزهايمر",
      user4: "صعوبات النطق",
      aboutTitle: "عن فوكسى",
      aboutDesc1: "فوكسى مصمم لجعل التواصل سلسًا ومتاحًا ومركّزًا على الإنسان. يوفر التطبيق أيقونات وعبارات جاهزة لتسهيل التفاعلات اليومية.",
    ...
    fr: {
      ...
      feature1: { title: "Communication facile", desc: "Exprimez vos besoins et sentiments grâce à des icônes visuelles intuitives." },
      feature2: { title: "Grande bibliothèque d'icônes", desc: "Des centaines d'icônes classées pour la communication quotidienne." },
      feature3: { title: "Rapide & Simple", desc: "Interface claire conçue pour les seniors et les enfants." },
      usersTitle: "Qui peut utiliser Voxi ?",
      user1: "Autisme",
      user2: "Survivants d’AVC",
      user3: "Alzheimer",
      user4: "Difficulté d'élocution",
    ...
    es: {
      ...
      feature1: { title: "Comunicación fácil", desc: "Expresa necesidades y sentimientos mediante iconos visuales intuitivos." },
      feature2: { title: "Gran biblioteca de iconos", desc: "Cientos de iconos categorizados para la comunicación diaria." },
      feature3: { title: "Rápido y simple", desc: "Interfaz limpia diseñada para personas mayores y niños." },
      usersTitle: "¿Quién puede usar Voxi?",
      user1: "Autismo",
      user2: "Supervivientes de accidentes cerebrovasculares",
      user3: "Alzheimer",
      user4: "Dificultad del habla",
      aboutTitle: "Acerca de Voxi",
      aboutDesc1: "Voxi está diseñado para hacer la comunicación fluida, accesible y centrada en el ser humano. Nuestra aplicación proporciona iconos y frases listas para usar que simplifican las interacciones diarias.",
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-center">
              <img src="https://cdn-icons-png.flaticon.com/512/2219/2219688.png" alt="Communication Illustration" className="img-fluid" style={{ maxHeight: "380px" }} />
            </div>
          </div>
        </div>
      </header>
            ...
            {[t.feature1, t.feature2, t.feature3].map((f,i)=>(
              <div key={i} className="col-md-4">
                <div className="p-4 shadow-sm rounded" style={{ backgroundColor: "var(--card-bg)" }}>
                  <img src={`https://cdn-icons-png.flaticon.com/512/${i===0?"1828640":i===1?"1828817":"1946433"}.png`} width="60" className="mb-3" />
      ...
      <section id="users" className="py-5">
        <div className="container">
          ...
          <div className="row g-4">
            {[
              { img: "https://tse1.mm.bing.net/th/id/OIP.g43UzrQ28BR1bm2ZiHOjVgHaE9?cb=ucfimg2&ucfimg=1&rs=1&pid=ImgDetMain&o=7&rm=3", name: t.user1 },
              { img: "https://cdn-icons-png.flaticon.com/512/4140/4140048.png", name: t.user2 },
              { img: "https://cdn-icons-png.flaticon.com/512/1300/1300921.png", name: t.user3 },
              { img: "https://cdn-icons-png.flaticon.com/512/2920/2920256.png", name: t.user4 },
            ].map((u,i)=>(
              <div key={i} className="col-md-3 text-center">
                <div className="p-4 rounded shadow-sm" style={{ backgroundColor: "var(--card-bg)" }}>
                  <img src={u.img} width="70" alt={u.name} style={{ objectFit: "cover" }} />
                  <h5 className="fw-bold mt-3">{u.name}</h5>
                </div>
              </div>
            ))}
          </div>
